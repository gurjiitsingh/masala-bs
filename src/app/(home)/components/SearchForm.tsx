    ...
    <div className="max-w-md w-full">
      <div className="relative">
        <input
          ...
          // className="w-full py-2 pl-10 pr-4 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-green-100 text-sm text-gray-800 shadow-sm placeholder-gray-400"
